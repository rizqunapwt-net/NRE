...
return [
    ...
    'description' => 'OpenAPI reference for the Rizquna Publishing platform, author portal, digital library, and administration APIs.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            This API reference is generated from the Laravel route layer and request validation rules.

            It includes OpenAPI output for Swagger UI, ReDoc, downloadable PDF export, authentication notes, and route-specific rate-limiting guidance.
        INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => 'Protected endpoints require a Laravel Sanctum bearer token in the <code>Authorization</code> header.',
    ],
